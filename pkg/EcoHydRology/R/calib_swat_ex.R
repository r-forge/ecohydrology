...
#data(change_params)
change_params[change_params$parameter=="SMFMX",]$min=0
change_params[change_params$parameter=="SMFMN",]$min=0
change_params[change_params$parameter=="ALPHA_BF",]$max=1.0
change_params[change_params$parameter=="TIMP",]$max=1.0
