...
runSWAT2005=function (hist_wx = NULL, elev = 100, rch = 3) {
     ...
     system(paste(path.package("SWATmodel"), libarch, swatbin, 
         sep = "/"))
...
test=runSWAT2005()
if(sum(test$FLOW_OUTcms)> 200){print("Your computer is having SWAT array issues, please contact drf28@cornell.edu\n")}
